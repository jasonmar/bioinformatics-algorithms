 ...
 */
import bioinf.Mutations._
import bioinf.Answer._
import bioinf.Output._
import scala.io.Source
val it = Source.fromFile("""C:\tmp\dataset_296_5.txt""").getLines()
val text = it.next()
val s = suffixTreeConstruction(text)
val d = deepestEdges(s)
val longestRepeats = d.map{printSuffix(s,_)}
val answer = longestRepeats.head
